...
const links = [
  {
    ...
    href: "https://cal.com/paramarsh-labs-tiw8tv",
    icon: <HelpIcon />,
    isLink: true,
  },
  {
  ...
  },
  {
    ...
    href: "https://medium.com/@paramarshlabs/taurus-swap-we-built-the-first-implementation-of-paradigms-orbital-amm-6aeb16656bb6",
    icon: <BlogIcon />,
    isLink: true,
  },
  {
